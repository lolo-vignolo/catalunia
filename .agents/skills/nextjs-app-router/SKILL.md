---
description: 'To build modern, full-stack React applications using the Next.js App Router (introduced in v13), leveraging React Server Components (RSC) for better performance. Use when: Building a new Next.js application; When you need Server Components, Layouts, or Streaming; Migrating from pages/ directory (gradually).'
metadata:
    github-path: skills/nextjs-app-router
    github-ref: refs/heads/main
    github-repo: https://github.com/jyjeanne/ai-setup-forge
    github-tree-sha: 77d5eb0ffda12c952a41846b99545af603418d7b
